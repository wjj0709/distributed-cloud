package com.phoenix.distributed.authorization.service;

import cn.hutool.core.util.StrUtil;
import com.phoenix.distributed.authorization.model.dto.UserInfo;
import com.phoenix.distributed.common.constant.SecurityConstants;
import com.phoenix.distributed.common.lang.R;
import com.phoenix.distributed.common.utils.RetOps;
...
public interface PigUserDetailsService extends UserDetailsService, Ordered {
    ...
    default UserDetails getUserDetails(R<UserInfo> result) {
        ...
        return new PigUser(info.getUserId(), info.getDept().getDeptId(), info.getUsername(),
                ...
                StrUtil.equals(info.getLockFlag(), "0"), authorities);
    }
